...
/// A small sheet to add a brand-new location with name, latitude, and longitude.
/// This view is used to create a new location entry if the user
/// selects "Add New Location" in the location picker.
struct NewLocationView: View {
   ...
   var body: some View {
       // Place gradient behind the form
       ZStack {
           // Gradient behind everything
           PastelGradientBackground()
 
           // Main content with window background color
           VStack {
...
struct EditJobView: View {
   ...
   var body: some View {
       // ZStack with a gradient behind everything.
       ZStack {
           GradientBackground()
               .ignoresSafeArea()
       ...
       // On appear, load any known locations
       .onAppear {
           loadLocations()
       }
       // QuickLook preview
...
/// A simple gradient background used in EditJobView.
/// This one is slightly different from PastelGradientBackground,
/// but we keep it for consistency with the existing design.
