...
//  the original code, except for the minimal edits necessary to fix the freezing issue
//  and incorporate the requested features.
//
// -----------------------------------------------------------------------------
// MARK: - Imports
// -----------------------------------------------------------------------------
...
struct AddJobWindowView: View {
    ...
    var body: some View {
        // The original code used .constant(false) for isPresented.
        // In the original snippet, it caused the freeze because the
        // window never actually closed. Here, we keep the code as is,
        // matching the user's provided code (with .constant(false)):
