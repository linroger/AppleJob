...
/// For the top 20 companies bar chart
...
/// For the Pie Chart of "Share by Year"
...
/// Example dictionary for city → lat/long
let CityCoordinateDictionary: [String: CLLocationCoordinate2D] = [
