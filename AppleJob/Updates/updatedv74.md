...
struct JobDetailView: View {
    ...
    var body: some View {
        ScrollView {
            ...
            .padding()
            .textSelection(.enabled) // Apply globally to the entire VStack
        }
    ...
    var body: some View {
        LinearGradient(
            gradient: Gradient(colors: [
                Color(red: 0.94, green: 0.85, blue: 1.0).opacity(0.8),  // Soft Lavender
                Color(red: 0.88, green: 0.95, blue: 0.90).opacity(0.8), // Mint Green
                Color(red: 1.0,  green: 0.94, blue: 0.9).opacity(0.8)    // Pale Yellow
            ]),
